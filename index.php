	...
	<div class="container">
		<div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start"
			...
			<div class="col-md-7 ftco-animate">
				...
				<h1 class="mb-4">Rent a hotel for your vacation</h1>
				<p><a href="<?php echo APPURL; ?>/about.php" class="btn btn-primary">Learn more</a> <a
						href="<?php echo APPURL; ?>/contact.php" class="btn btn-white">Contact us</a></p>
			</div>
		</div>
	</div>
</div>
				...
				<div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
					<div class="d-block services-wrap text-center">
						...
						<div class="media-body py-4 px-3">
							...
							<p><a href="<?php echo APPURL; ?>/rooms.php?id=<?php echo $hotel->id; ?>"
									class="btn btn-primary">View rooms</a></p>
					...
					<div class="room-wrap d-md-flex">
						...
						<div class="half left-arrow d-flex align-items-center">
							<div class="text p-4 p-xl-5 text-center">
								...
								<h3 class="mb-3"><a
										href="<?php echo APPURL; ?>/rooms/room-single.php?id=<?php echo $room->id; ?> "><?php echo $room->name; ?></a>
								</h3>
								...
								<p class="pt-1"><a
										href="<?php echo APPURL; ?>/rooms/room-single.php?id=<?php echo $room->id; ?>"
